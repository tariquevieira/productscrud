...
use Desafio\Produto\Modules\Product\Controllers\UpdateProductController;
use InvalidArgumentException;
use Psr\Http\Message\ResponseInterface;
use Psr\Http\Message\ServerRequestInterface;

class UpdateProductControllerProxy extends ControllerProxy
{
  ...
  public function handle(ServerRequestInterface $request): ResponseInterface
  {
    try {
      ...
      return $this->handleController(UpdateProductController::class, $request);
